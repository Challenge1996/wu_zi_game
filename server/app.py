...
def main():
    ...
    print("  GET  /api/room/public_list     获取公开对局列表（含观战人数和热门标识）")
    print("  POST /api/room/spectate        加入观战")
    print("  POST /api/room/leave_spectate  离开观战")
    ...
    print("\n【聊天相关】")
    print("  POST /api/chat/send            发送聊天消息（玩家和观战者都可以）")
    ...
    print("\n观战流程：")
    print("1. 其他玩家注册并登录")
    print("2. 查看公开对局列表（GET /api/room/public_list）")
    print("3. 选择感兴趣的对局加入观战（POST /api/room/spectate）")
    print("4. 观战者可以查看棋盘和聊天，但不能操作棋局")
    print("5. 观战人数大于1的对局会显示热门标识")
    print("6. 随时可以离开观战（POST /api/room/leave_spectate）")
    print("=" * 60)
